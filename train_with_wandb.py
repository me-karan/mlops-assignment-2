...
def main() -> None:
    parser = argparse.ArgumentParser(description='Train a BERT classifier with Weights & Biases logging.')
    ...
    parser.add_argument('--output_dir', default='./results_wandb')
    parser.add_argument('--project_name', default='mlops-assignment2')
    parser.add_argument('--run_name', default='distilbert-wandb-run')
    ...
    print(f'Training complete. Model, tokenizer, and W&B run {args.run_name} saved to {output_dir}')
